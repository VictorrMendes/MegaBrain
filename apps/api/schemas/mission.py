...
class ApprovalContext(BaseModel):
    """Rich approval context generated by LLMPlanProvider (Human Approval 2.0).

    Populated when a mission is in waiting_approval status and was planned
    by the LLM. Frontend uses this to display a structured approval dialog.
    """
